...
wget -O /etc/xray/geoip.dat https://raw.githubusercontent.com/Rolka111111/large/sae/xray/geoip.dat
wget -O /etc/xray/geosite.dat https://raw.githubusercontent.com/Rolka111111/large/sae/xray/geosite.dat
